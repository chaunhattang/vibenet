...
export function toggleReelReaction(reelId: string, type: ReactionType) {
  return unwrap<ReactionType | null>(apiClient.post(`/api/reels/${reelId}/reactions`, null, { params: { type } }));
}
